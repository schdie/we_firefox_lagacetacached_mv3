...
function scrollBar() {
    ...
    window.addEventListener("scroll", (function () {
			...
			l > e ? (i || t.classList.remove("is-up"), s && (t.classList.add("esp"), document.querySelector("#brandHeader").src = URL_ACTUAL + "assets/2022/images/brandw.svg")) : e > l && (window.scrollY > r ? (i || t.classList.add("is-up"), document.querySelector("#brandHeader").src = URL_ACTUAL + "assets/2022/images/brand.svg")) : (i || t.classList.remove("is-up"), s && (t.classList.add("esp"), document.querySelector("#brandHeader").src = URL_ACTUAL + "assets/2022/images/brandw.svg"))),
            e = l <= 0 ? 0 : l
        }))
}
