...
function scrollBar() {
	var e = window.scrollY,
		...
		o = !1,
		l = 20;
	t.classList.contains("is-home") ? a = !0 : t.classList.contains("is-home-m") ? (s = !0, o = !0) : t.classList.contains("is-mobile") && (o = !0), t.classList.contains("esp") && (i = !0), window.addEventListener("scroll", function() {
		var r = window.scrollY;
		if (a) l = 600, window.scrollY > 600 && (t.classList.add("sticky", "small"), document.body.style.paddingTop = "265px"), window.scrollY <= 600 && (t.classList.remove("sticky", "small"), document.body.style.paddingTop = "0px");
		else {
			if (s) var d = 148;
			else var d = 1;
			window.scrollY > d ? (t.classList.add("sticky"), o && t.classList.add("is-up"), s ? (document.body.style.paddingTop = "130px", n && (n.style.visibility = "hidden")) : o && n && (n.style.marginTop = "70px")) : (t.classList.remove("sticky"), o && t.classList.remove("is-up"), s ? (document.body.style.paddingTop = "0px", n && (n.style.visibility = "visible")) : o && n && (n.style.marginTop = "0px"))
		}
...
function sendOnesignal(e, t, n, i, a) {
	var s = window.OneSignal || [];
	s.push(function() {
		s.init({
			appId: n,
			promptOptions: {
		...
		}), s.setExternalUserId(e), t && s.sendTag("suscripto", "si").then(function(e) {})
	})
}
...
var minxmin = {
	...
	getTime: function(e) {
		var t = new Date(e).getTime(),
			...
			a = parseInt(n / 1e3 / 60 - 60 * i),
			s = parseInt(n / 1e3 - 3600 * i - 60 * a);
		return i > 0 ? (i > 9 ? i : "0" + i) + ":" + (a > 9 ? a : "0" + a) + ":" + (s > 9 ? s : "0" + s) : (a > 9 ? a : "0" + a) + ":" + (s > 9 ? s : "0" + s)
	},
	...
	ajaxCall: function(e) {
		...
		var n = e.getElementsByClassName("js-reloj-mam")[0],
			...
			a = n.dataset.uniq,
			s = e.getElementsByClassName("js-descripcion-estado")[0];
		...
		var l = e.getElementsByClassName("js-local-name")[0],
			...
			g = function(e) {
				switch (l.innerHTML = e.local_abbr, r.innerHTML = e.visita_abbr, d.setAttribute("src", e.escudo_local), c.setAttribute("src", e.escudo_visita), e.gol_penal_local ? m.innerHTML = '<span style="font-size:10px;">(' + e.gol_penal_local + ")</span>" + e.gol_local + " . " + e.gol_visita + '<span style="font-size:10px;">(' + e.gol_penal_visita + ")</span>" : m.innerHTML = e.gol_local + " . " + e.gol_visita, n.dataset.fecha_estado = e.fecha_inicio_estado, parseInt(e.mam_estado)) {
					case 0:
						i.innerHTML = e.fecha_corta + " " + e.hora_inicio + " hrs", s.innerHTML = "", o && (o.innerHTML = "");
						break;
					case 1:
						minxmin.iniciarReloj(n, a, i), s.innerHTML = "PT", o && (o.innerHTML = e.incidencias);
						break;
					case 2:
						minxmin.stop(a), e.fecha_corta ? i.innerHTML = e.fecha_corta : i.innerHTML = "Fin", s.innerHTML = "", o && (o.innerHTML = e.incidencias);
						break;
					case 3:
						minxmin.stop(a), i.innerHTML = "Susp", s.innerHTML = "", o && (o.innerHTML = e.incidencias);
						break;
					case 4:
						minxmin.stop(a), i.innerHTML = "Post", s.innerHTML = "";
						break;
					case 5:
					case 9:
						minxmin.stop(a), i.innerHTML = "ET", s.innerHTML = "", o && (o.innerHTML = e.incidencias);
						break;
					case 6:
						minxmin.iniciarReloj(n, a, i), s.innerHTML = "ST", o && (o.innerHTML = e.incidencias);
						break;
					case 7:
						minxmin.stop(a), i.innerHTML = "Alar", s.innerHTML = "", o && (o.innerHTML = e.incidencias);
						break;
					case 8:
						minxmin.iniciarReloj(n, a, i), s.innerHTML = "PTA", o && (o.innerHTML = e.incidencias);
						break;
					case 10:
						minxmin.iniciarReloj(n, a, i), s.innerHTML = "STA", o && (o.innerHTML = e.incidencias);
						break;
					case 11:
						minxmin.stop(a), i.innerHTML = "Fin", s.innerHTML = "", o && (o.innerHTML = e.incidencias);
						break;
					case 12:
						minxmin.stop(a), i.innerHTML = "Pen", s.innerHTML = "", o && (o.innerHTML = e.incidencias), minxmin.intervalos["penales_partido_" + t] || (clearInterval(minxmin.intervalos["partido_" + t]), u.startInterval("penales_partido_", 10, t, g))
				}
			};
	...
	ajaxCallCards: function(e) {
		var t = e.dataset.pid,
			...
			s = e.getElementsByClassName("js-escudo-visita")[0],
			o = e.getElementsByClassName("js-resultado")[0],
			l = function(e) {
				if (e.local_abbr) switch (n.innerHTML = e.local_abbr, i.innerHTML = e.visita_abbr, a.setAttribute("src", e.escudo_local), s.setAttribute("src", e.escudo_visita), parseInt(e.mam_estado)) {
					case 2:
...
function showModal(e) {
	...
	var a = window.scrollY,
		s = !1;
	header.classList.contains("is-home-m") ? s = !0 : header.classList.contains("is-mobile") && (s = !0), "mshare" == e && s ? t.style.cssText = "" : "mlist" == e && s ? t.style.cssText = "" : t.style.cssText = "top: " + (a + 350) + "px", t.classList.add("is--visible"), i.classList.add("is-blacked-out"), document.getElementsByTagName("html")[0].style.overflow = "hidden", n.addEventListener("click", () => {
	...
	paywall.queue.push(["invoke", "viewSubscriptionData", function(e) {
		if (e && e.is_active && e.card && e.card.expiration_date) {
			var t = new Date,
				...
				s = e.failed_payments,
				o = e.resource.price;
			(a <= i || a < t || s > 1) && o > 0 && (req_sign.open("POST", URL_ACTUAL + "ajax/notif_susc", !0), req_sign.send(), req_sign.onload = function() {
				200 == req_sign.status && (resp = JSON.parse(req_sign.response)).estado && resp.user_id == e.subscriber.user_id && (s > 1 ? (console.log("Moroso"), pushEventGTM("NotifSuscriptor", "NotifSuscriptor", "Moroso", "AvisoSuscriptor", 1)) : a < t ? (console.log("Tarjeta vencida"), pushEventGTM("NotifSuscriptor", "NotifSuscriptor", "TarjetaVencida", "AvisoSuscriptor", 1)) : a <= i && (console.log("Tarjeta por vencer"), pushEventGTM("NotifSuscriptor", "NotifSuscriptor", "TarjetaPorVencer", "AvisoSuscriptor", 1)))
			})
		}
	}])
}
	...
	i.open("POST", URL_ACTUAL + "widget/show_widget_list_form", !0), i.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), i.send("list_id=" + n + "&nota_id=" + t), i.onload = function() {
		if (200 == i.status && (resp = JSON.parse(i.response)).status) {
			if ("object" != typeof grecaptcha) {
				var t, n, a, s = "script";
				(n = (t = document).createElement(s)).type = "text/java" + s, n.async = "async", n.src = "https://www.google.com/recaptcha/api.js?render=6LdM4ZQUAAAAAJxQkCG_8CujiKFD9HnnhrgIlPAn", (a = t.getElementsByTagName(s)[0]).parentNode.insertBefore(n, a)
			}
...
function pushEventGTM(e, t, n, i, a) {
	dataLayer.push({
		event: e,
		eventCategory: t,
		eventAction: n,
...
function agregarBanner(e, t, n) {
	...
	o.setAttribute("id", "adslot" + t.id), o.setAttribute("style", "min-height:" + i + "px; min-width:" + a + "px; text-align:left; overflow-x:hidden; justify-content:left; margin-left:auto; margin-right:auto;"), s.appendChild(o), document.getElementById(e).appendChild(s), googletag.cmd.push(function() {
